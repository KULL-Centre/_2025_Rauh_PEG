...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  4 15:32:19 2023
...
def simulate(residues,dirname,proteins,composition,temp,ionic,cutoff,boxlength):
    ...
    simulation.runForClockTime(24*unit.hour,checkpointFile=check_point,checkpointInterval=0.5*unit.hour)
...
if __name__=="__main__":
    ...
    residues.loc['J','lambdas'] = args.lambda_peg
